...
class DATABASE_CONFIG {
	...
	public $default = array(
		...
		'login' => 'root',
		//'port' => '3307',
		// Triple DES password in Base64
		'password' => '', //'password' => 'calidadit',
		'database' => '',
		'prefix' => '',
		//'encoding' => 'utf8',
	);
	...
	public $soap = array(
		'datasource' => 'Soap.SoapSource',
		'wsdl' => 'http://mantis/api/soap/mantisconnect.php?wsdl',
		'location' => 'http:///mantis/api/soap/mantisconnect.php', // Required for non wsdl mode
		...
		//'proxy_host' => 'proxy.tpr.bancaribe', // optional
		//'proxy_port' => 80, // optional
		//'proxy_login' => 'bc211366',
		//'proxy_password' => 'bancaribe.2027',
		'login' => '',
		'password' => '', 
	);
}
