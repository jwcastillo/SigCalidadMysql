...
class HighChartsComponent extends Component {
    ...
    public function setChartParams($name, $params = array()) {
		...
		if (isset($params['plotOptionsPieShowInLegend'])) {           
            $this->charts[$name]->plotOptions = (isset($this->charts[$name]->plotOptions)) ? $this->charts[$name]->plotOptions : new stdClass(); 
            $this->charts[$name]->plotOptions->pie = (isset($this->charts[$name]->plotOptions->pie)) ? $this->charts[$name]->plotOptions->pie :  new HighRollerPlotOptionsByChartType($this->charts[$name]->chart->type);  
