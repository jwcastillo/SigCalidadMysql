...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-th"></i>&nbsp;<?php echo __('Complexity'); ?></h2>
		</div>
		<div class="box-content">
			<div class="row-fluid">
			<dl class="view">
				<dt><h4><?php echo __('Id'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($complexity['Complexity']['id']); ?></dd>

				<dt><h4><?php echo __('Name'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($complexity['Complexity']['name']); ?></dd>

				<dt><h4><?php echo __('Created'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($complexity['Complexity']['created']); ?></dd>

				<dt><h4><?php echo __('Modified'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($complexity['Complexity']['modified']); ?></dd>
...
<li><?php echo $this->Charisma->iconLink(__('Edit Complexity'), 
		array('action' => 'edit',	$complexity['Complexity']['id']), 
		'icon-pencil'); ?>
</li>

<li><?php echo $this->Charisma->deleteLink(__('Delete Complexity'), 
		array('action' => 'delete', $complexity['Complexity']['id']), 
		'icon-trash'); ?>
</li>
...
<li><?php echo $this->Charisma->iconLink( __('New Complexity'), 
		array('action' => 'add'), 
		'icon-plus'); ?>
</li>
<!-- Related -->
		...
		<div class="box-content">
			<div class="row-fluid">
				...
				<table class="table table-bordered table-striped table-condensed">
					...
					<tbody>
					<?php foreach ($complexity['Rfc'] as $rfc): ?>
					<tr>
