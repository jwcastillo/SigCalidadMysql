			...
			<?php $this->Form->inputDefaults($this->Charisma->getInputDefaults()); ?>
				<fieldset>
					<?php
						...
						$selected = array_search($rfc['Rfc']['architecture'], $architectures);
...
//
	...
	$(document).ready(function() {
		...
		var loadUrl = "<?php echo Router::url(array('controller'=>'project_managers', 'action'=>'getList.json'));?>";
