...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-user"></i>&nbsp;<?php echo __('Package Classes'); ?></h2>
		</div>
		<div class="box-content">
			<table class="table table-striped table-bordered">
				...
				<tbody>
					<?php foreach ($packageClasses as $packageClass): ?>
					<tr>
						<td><?php echo h($packageClass['PackageClass']['id']); ?>&nbsp;</td>
						<td><?php echo h($packageClass['PackageClass']['name']); ?>&nbsp;</td>
						<td><?php echo h($packageClass['PackageClass']['created']); ?>&nbsp;</td>
						<td><?php echo h($packageClass['PackageClass']['modified']); ?>&nbsp;</td>
						<td class="actions center">
							<?php echo $this->Charisma->iconButton(__('View'), 
								array('action' => 'view', $packageClass['PackageClass']['id']), 
