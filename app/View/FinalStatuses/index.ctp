...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-user"></i>&nbsp;<?php echo __('Final Statuses'); ?></h2>
		</div>
		<div class="box-content">
			<table class="table table-striped table-bordered">
				...
				<tbody>
					<?php foreach ($finalStatuses as $finalStatus): ?>
					<tr>
						<td><?php echo h($finalStatus['FinalStatus']['id']); ?>&nbsp;</td>
						<td><?php echo h($finalStatus['FinalStatus']['name']); ?>&nbsp;</td>
						<td><?php echo h($finalStatus['FinalStatus']['created']); ?>&nbsp;</td>
						<td><?php echo h($finalStatus['FinalStatus']['modified']); ?>&nbsp;</td>
						<td class="actions center">
							<?php echo $this->Charisma->iconButton(__('View'), 
								array('action' => 'view', $finalStatus['FinalStatus']['id']), 
