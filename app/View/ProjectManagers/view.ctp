...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-th"></i>&nbsp;<?php echo __('Project Manager'); ?></h2>
		</div>
		<div class="box-content">
			<div class="row-fluid">
			<dl class="view">
				<dt><h4><?php echo __('Id'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($projectManager['ProjectManager']['id']); ?></dd>

				<dt><h4><?php echo __('Name'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($projectManager['ProjectManager']['name']); ?></dd>

				<dt><h4><?php echo __('Created'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($projectManager['ProjectManager']['created']); ?></dd>

				<dt><h4><?php echo __('Modified'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($projectManager['ProjectManager']['modified']); ?></dd>
...
<li><?php echo $this->Charisma->iconLink(__('Edit Project Manager'), 
		array('action' => 'edit',	$projectManager['ProjectManager']['id']), 
		'icon-pencil'); ?>
</li>

<li><?php echo $this->Charisma->deleteLink(__('Delete Project Manager'), 
		array('action' => 'delete', $projectManager['ProjectManager']['id']), 
		'icon-trash'); ?>
</li>
...
<li><?php echo $this->Charisma->iconLink( __('New Project Manager'), 
		array('action' => 'add'), 
		'icon-plus'); ?>
</li>
<!-- Related -->
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<div class="row-fluid">
				<?php if (!empty($projectManager['Rfc'])): ?>
				<table class="table table-bordered table-striped table-condensed">
					...
					<tbody>
					<?php foreach ($projectManager['Rfc'] as $rfc): ?>
					<tr>
