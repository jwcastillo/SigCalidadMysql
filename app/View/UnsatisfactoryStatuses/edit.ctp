	...
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i>&nbsp;
				<?php echo __('Edit Unsatisfactory Status'); ?>
			</h2>
		</div>
		<div class="box-content">
			<?php echo $this->Form->create('UnsatisfactoryStatus', array('class' => 'form-horizontal')); ?>
			<?php $this->Form->inputDefaults($this->Charisma->getInputDefaults()); ?>
				<fieldset>
					<?php
						...
						echo $this->Form->input('Package', $this->Charisma->getSelectOptions());
					?>
...
<li><?php echo $this->Charisma->deleteLink(__('Delete'), 
		array('action' => 'delete', $this->Form->value('UnsatisfactoryStatus.id')), 
		'icon-trash'); ?>
</li>
