...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-th"></i>&nbsp;<?php echo __('Project Class'); ?></h2>
		</div>
		<div class="box-content">
			<div class="row-fluid">
			<dl class="view">
				<dt><h4><?php echo __('Id'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($projectClass['ProjectClass']['id']); ?></dd>

				<dt><h4><?php echo __('Name'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($projectClass['ProjectClass']['name']); ?></dd>

				<dt><h4><?php echo __('Created'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($projectClass['ProjectClass']['created']); ?></dd>

				<dt><h4><?php echo __('Modified'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($projectClass['ProjectClass']['modified']); ?></dd>
...
<li><?php echo $this->Charisma->iconLink(__('Edit Project Class'), 
		array('action' => 'edit',	$projectClass['ProjectClass']['id']), 
		'icon-pencil'); ?>
</li>

<li><?php echo $this->Charisma->deleteLink(__('Delete Project Class'), 
		array('action' => 'delete', $projectClass['ProjectClass']['id']), 
		'icon-trash'); ?>
</li>
...
<li><?php echo $this->Charisma->iconLink( __('New Project Class'), 
		array('action' => 'add'), 
		'icon-plus'); ?>
</li>
<!-- Related -->
		...
		<div class="box-content">
			<div class="row-fluid">
				...
				<table class="table table-bordered table-striped table-condensed">
					...
					<tbody>
					<?php foreach ($projectClass['Rfc'] as $rfc): ?>
					<tr>
