...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-user"></i>&nbsp;<?php echo __('Project Classes'); ?></h2>
		</div>
		<div class="box-content">
			<table class="table table-striped table-bordered">
				...
				<tbody>
					<?php foreach ($projectClasses as $projectClass): ?>
					<tr>
						<td><?php echo h($projectClass['ProjectClass']['id']); ?>&nbsp;</td>
						<td><?php echo h($projectClass['ProjectClass']['name']); ?>&nbsp;</td>
						<td><?php echo h($projectClass['ProjectClass']['created']); ?>&nbsp;</td>
						<td><?php echo h($projectClass['ProjectClass']['modified']); ?>&nbsp;</td>
						<td class="actions center">
							<?php echo $this->Charisma->iconButton(__('View'), 
								array('action' => 'view', $projectClass['ProjectClass']['id']), 
