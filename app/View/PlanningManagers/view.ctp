...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-th"></i>&nbsp;<?php echo __('Planning Manager'); ?></h2>
		</div>
		<div class="box-content">
			<div class="row-fluid">
			<dl class="view">
				<dt><h4><?php echo __('Id'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($planningManager['PlanningManager']['id']); ?></dd>

				<dt><h4><?php echo __('Name'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($planningManager['PlanningManager']['name']); ?></dd>

				<dt><h4><?php echo __('Created'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($planningManager['PlanningManager']['created']); ?></dd>

				<dt><h4><?php echo __('Modified'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($planningManager['PlanningManager']['modified']); ?></dd>
...
<li><?php echo $this->Charisma->iconLink(__('Edit Planning Manager'), 
		array('action' => 'edit',	$planningManager['PlanningManager']['id']), 
		'icon-pencil'); ?>
</li>

<li><?php echo $this->Charisma->deleteLink(__('Delete Planning Manager'), 
		array('action' => 'delete', $planningManager['PlanningManager']['id']), 
		'icon-trash'); ?>
</li>
...
<li><?php echo $this->Charisma->iconLink( __('New Planning Manager'), 
		array('action' => 'add'), 
		'icon-plus'); ?>
</li>
<!-- Related -->
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<div class="row-fluid">
				<?php if (!empty($planningManager['Rfc'])): ?>
				<table class="table table-bordered table-striped table-condensed">
					...
					<tbody>
					<?php foreach ($planningManager['Rfc'] as $rfc): ?>
					<tr>
