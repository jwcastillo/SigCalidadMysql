...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-user"></i>&nbsp;<?php echo __('Planning Managers'); ?></h2>
		</div>
		<div class="box-content">
			<table class="table table-striped table-bordered">
				...
				<tbody>
					<?php foreach ($planningManagers as $planningManager): ?>
					<tr>
						<td><?php echo h($planningManager['PlanningManager']['id']); ?>&nbsp;</td>
						<td><?php echo h($planningManager['PlanningManager']['name']); ?>&nbsp;</td>
						<td><?php echo h($planningManager['PlanningManager']['created']); ?>&nbsp;</td>
						<td><?php echo h($planningManager['PlanningManager']['modified']); ?>&nbsp;</td>
						<td class="actions center">
							<?php echo $this->Charisma->iconButton(__('View'), 
								array('action' => 'view', $planningManager['PlanningManager']['id']), 
