	...
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i>&nbsp;
				<?php echo __('Edit Planning Manager'); ?>
			</h2>
		</div>
		<div class="box-content">
			<?php echo $this->Form->create('PlanningManager', array('class' => 'form-horizontal')); ?>
...
<li><?php echo $this->Charisma->deleteLink(__('Delete'), 
		array('action' => 'delete', $this->Form->value('PlanningManager.id')), 
		'icon-trash'); ?>
</li>
