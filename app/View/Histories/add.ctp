	...
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i>&nbsp;
				<?php echo __('Add History'); ?>
			</h2>
		</div>
		<div class="box-content">
			<?php echo $this->Form->create('History', array('class' => 'form-horizontal')); ?>
			<?php $this->Form->inputDefaults($this->Charisma->getInputDefaults()); ?>
				<fieldset>
					<?php
						echo $this->Form->input('number_package');
						echo $this->Form->input('stage_name');
						echo $this->Form->input('change_date', $this->Charisma->getDateOptions());
...
<li><?php echo $this->Charisma->deleteLink(__('Delete'), 
		array('action' => 'delete', $this->Form->value('History.Id')), 
		'icon-trash'); ?>
</li>
