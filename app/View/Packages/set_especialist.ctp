...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i>&nbsp;<?php echo __('Package'); ?></h2>
		</div>
...
<div class="box span6">
	<div data-original-title="" class="box-header well">
		<h2><i class="icon-edit"></i>&nbsp;<?php echo __('Set Especialist'); ?>
	</div>
	<div class="box-content">
	...
	<?php $this->Form->inputDefaults($this->Charisma->getInputDefaults()); ?>
		<fieldset>
			...
			<?php
				...
				$selected = array_search($package['Package']['type'], $types);
				echo $this->Form->input('type', 
					array_merge($this->Charisma->getSelectOptions(), compact('selected'))
				);
				echo $this->Form->input('entry_date', array('type' => 'hidden'));
				echo $this->Form->input('start_date', $this->Charisma->getDateOptions());
				echo $this->Form->input('end_date', $this->Charisma->getDateOptions());
				echo $this->Form->input('weighting', $this->Charisma->getSpinnerOptions());
				echo $this->Form->input('auto_assign', array('type' => 'checkbox'));
...
<div class="box span6">
	...
	<div id="workload" class="box-content">
	</div>
</div>
