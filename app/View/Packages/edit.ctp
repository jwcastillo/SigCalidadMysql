			...
			<?php $this->Form->inputDefaults($this->Charisma->getInputDefaults()); ?>
				<fieldset>
					<?php
						...
						echo $this->Form->input('effec_eval_date', $this->Charisma->getDateOptions());
						echo $this->Form->input('qual_eval_date', $this->Charisma->getDateOptions());
...
<li><?php echo $this->Charisma->iconLink(
				__('New Observation'), 
				array('controller' => 'observations', 'action' => 'add'), 
				'icon-plus'); ?>
</li>
<li><?php echo $this->Charisma->iconLink(
				__('List Histories'), 
...
<li><?php echo $this->Charisma->iconLink(
				__('New History'), 
				array('controller' => 'histories', 'action' => 'add'), 
				'icon-plus'); ?>
</li>
<li><?php echo $this->Charisma->iconLink(
				__('List Unsatisfactory Statuses'), 
				array('controller' => 'unsatisfactory_statuses', 'action' => 'index'), 
				'icon-align-justify'); ?>
</li>
<li><?php echo $this->Charisma->iconLink(
				__('New Unsatisfactory Status'), 
				array('controller' => 'unsatisfactory_statuses', 'action' => 'add'), 
				'icon-plus'); ?>
</li>
<?php $this->end(); ?>
