...
<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header well" data-original-title>
				<h2><i class="icon-edit"></i> <?php echo __('Replanning'); ?></h2>
			</div>
			<div class="box-content">
				<dl class="view">
					...
					<dd>&nbsp;<?php echo $this->Html->link($package['Package']['employee'], array('controller' => 'employees', 'action' => 'view', $package['Employee']['id'])); ?></dd>
				...
				<hr/>
					...
					<fieldset>
						<?php
							...
							echo $this->Form->input('start_date', array('type' => 'hidden'));
							echo $this->Form->input('end_date', array('type' => 'hidden'));
						?>
