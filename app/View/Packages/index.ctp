...
<div class="row-fluid sortable">		
	<div class="box span12">
		...
		<div class="box-content">
			<table id="packages" class="table table-bordered table-striped table-condensed bootstrap-datatable datatable" cellspacing="0" width="100%">
				<thead>
					<tr>
						<?php 
						if (!isset($columns)) {
...
//<![CDATA[
	...
	$(document).ready(function() {
		...
		$('table.dataTable tfoot').each(function () { $(this).insertBefore($(this).siblings('tbody')); }); 
	});
//]]>
</script>
