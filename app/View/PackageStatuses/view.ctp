...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-th"></i>&nbsp;<?php echo __('Package Status'); ?></h2>
		</div>
		<div class="box-content">
			<div class="row-fluid">
			<dl class="view">
				<dt><h4><?php echo __('Id'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($packageStatus['PackageStatus']['id']); ?></dd>

				<dt><h4><?php echo __('Name'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($packageStatus['PackageStatus']['name']); ?></dd>

				<dt><h4><?php echo __('Created'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($packageStatus['PackageStatus']['created']); ?></dd>

				<dt><h4><?php echo __('Modified'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($packageStatus['PackageStatus']['modified']); ?></dd>
...
<li><?php echo $this->Charisma->iconLink(__('Edit Package Status'), 
		array('action' => 'edit',	$packageStatus['PackageStatus']['id']), 
		'icon-pencil'); ?>
</li>

<li><?php echo $this->Charisma->deleteLink(__('Delete Package Status'), 
		array('action' => 'delete', $packageStatus['PackageStatus']['id']), 
		'icon-trash'); ?>
</li>
...
<li><?php echo $this->Charisma->iconLink( __('New Package Status'), 
		array('action' => 'add'), 
		'icon-plus'); ?>
</li>
<!-- Related -->
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<div class="row-fluid">
				<?php if (!empty($packageStatus['Package'])): ?>
				<table id="ajax-table" class="table table-bordered table-striped table-condensed">
					...
					<tbody>
					<?php foreach ($packageStatus['Package'] as $package): ?>
					<tr>
