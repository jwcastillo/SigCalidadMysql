...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-th"></i>&nbsp;<?php echo __('Development Manager'); ?></h2>
		</div>
		<div class="box-content">
			<div class="row-fluid">
			<dl class="view">
				<dt><h4><?php echo __('Id'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($developmentManager['DevelopmentManager']['id']); ?></dd>

				<dt><h4><?php echo __('Name'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($developmentManager['DevelopmentManager']['name']); ?></dd>

				<dt><h4><?php echo __('Created'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($developmentManager['DevelopmentManager']['created']); ?></dd>

				<dt><h4><?php echo __('Modified'); ?></h4></dt>
				<dd>&nbsp;<?php echo h($developmentManager['DevelopmentManager']['modified']); ?></dd>
...
<li><?php echo $this->Charisma->iconLink(__('Edit Development Manager'), 
		array('action' => 'edit',	$developmentManager['DevelopmentManager']['id']), 
		'icon-pencil'); ?>
</li>

<li><?php echo $this->Charisma->deleteLink(__('Delete Development Manager'), 
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<div class="row-fluid">
				<?php if (!empty($developmentManager['Rfc'])): ?>
				<table class="table table-bordered table-striped table-condensed">
					...
					<tbody>
					<?php foreach ($developmentManager['Rfc'] as $rfc): ?>
					<tr>
