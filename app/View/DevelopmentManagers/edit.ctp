	...
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i>&nbsp;
				<?php echo __('Edit Development Manager'); ?>
			</h2>
		</div>
		<div class="box-content">
			<?php echo $this->Form->create('DevelopmentManager', array('class' => 'form-horizontal')); ?>
...
<li><?php echo $this->Charisma->deleteLink(__('Delete'), 
		array('action' => 'delete', $this->Form->value('DevelopmentManager.id')), 
		'icon-trash'); ?>
</li>
