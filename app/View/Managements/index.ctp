...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-user"></i>&nbsp;<?php echo __('Managements'); ?></h2>
		</div>
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo h($management['Management']['name']); ?>&nbsp;</td>
						<td><?php echo h($management['Management']['created']); ?>&nbsp;</td>
						<td><?php echo h($management['Management']['modified']); ?>&nbsp;</td>
						<td class="actions center">
							<?php echo $this->Charisma->iconButton(__('View'), 
								array('action' => 'view', $management['Management']['id']), 
