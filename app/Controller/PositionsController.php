	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Position->save($this->request->data)) {
				$this->Session->setFlash(__('The position has been saved.'), 'flash', array ('class' => 'success'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The position could not be saved. Please, try again.'), 'flash', array ('class' => 'error'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Position->delete()) {
			$this->Session->setFlash(__('The position has been deleted.'), 'flash', array ('class' => 'block'));
		} else {
			$this->Session->setFlash(__('The position could not be deleted. Please, try again.'), 'flash', array ('class' => 'error'));
		}
		return $this->redirect(array('action' => 'index'));
	}}
